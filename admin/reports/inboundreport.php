...
function viewrep(_clientid, _projectid, _memberid, _teamid, _start, _end)
{
    ...
    $ottreportsummary.dataTable( {
        ...
        "sAjaxSource": "?act=loadreportsummary"+"&_projectid="+_projectid+"&_start="+_start+"&_end="+_end,
        "fnInitComplete": function () {
            ...
            $ottreportlog.dataTable( {
                "sAjaxSource": "?act=loadreport"+"&_projectid="+_projectid+"&_start="+_start+"&_end="+_end,
                "fnInitComplete": function () {
                    $('#reporttabs').tabs({active: 0});
                }
            } );
...
$(document).ready(
    ...
    function() {
        ...
        $ottreportsummary = $('#ttreportsummary').dataTable( {
            "sAjaxSource": "?act=loadreportsummary"+"&_projectid="+$('#projects').val()+"&_start="+$('#start').val()+' '+ConvertTimeformat('00:00',$('#starttime').val())+"&_end="+$('#end').val()+' '+ConvertTimeformat('00:00',$('#endtime').val()),
            "fnInitComplete": function () {

                $('#reporttabs').tabs({active: 1});
                $ottreportlog = $('#ttreportlog').dataTable( {
                    "sAjaxSource": "?act=loadreport"+"&_projectid="+$('#projects').val()+"&_start="+$('#start').val()+' '+ConvertTimeformat('00:00',$('#starttime').val())+"&_end="+$('#end').val()+' '+ConvertTimeformat('00:00',$('#endtime').val()),
                    "fnInitComplete": function () {
                        $('#reporttabs').tabs({active: 0});
                    }
                } );
